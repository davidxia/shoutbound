  ...
  <div class="onboarding-main">
      ...
      <div id="onboarding-left">  
        <div id="left-content-container">
          ...
          <div><span class="place fakelink right-item-entry placeleftpull" lat="<?=$future_place->lat?>" lng="<?=$future_place->lng?>"><?=$future_place->name?><? if($future_place->country AND $future_place->country != $future_place->name){echo ', '.$future_place->country;}?></span> <a href="#" class="remove-place" id="place-<?=$future_place->id?>">remove</a></div>
          <? endforeach;?>
          <form id="bucket-list">
          <fieldset>
