...
<? $this->load->view('templates/content')?>
  ...
  <div class="home-left" style="width:640px;">
    ...
    <div class="article">
      ...
      <div class="icon" style="background: url(http://s.shoutbound.com/images/sprites.png) no-repeat 0px -23px;display:inline-block;padding-left:25px;vertical-align:2px;margin-right:10px;font-size:18px;color:#F93;"><?=$article->num_wishers?></div>
  ...
  <!--     <div><?=date('F j, Y', $article->created)?></div> -->
      ...
      <div>
        <div class="icon" style="background: url(http://s.shoutbound.com/images/sprites.png) no-repeat 0px -63px;display:inline-block;padding-left:28px;vertical-align:middle;margin-right:10px;">
