<div id="followers-tab" class="main-tab-content">
  ...
  <? $prefix='first-item'; foreach ($trip->followers as $follower):?>
      ...
      <div class="streamitem-avatar-container">
        <a href="<? if($follower->username){echo site_url($follower->username);}else{echo site_url('profile/'.$follower->id);}?>"><img src="<?=static_sub('profile_pics/'.$follower->profile_pic)?>" height="25" width="25"/></a>
      </div>         
