...
class User_m extends CI_Model
{
    ...
    public function set_rsvp_role_for_trip_id($trip_id = NULL, $rsvp = NULL, $role = NULL)
    {
        ...
        {
            $this->mc->replace('rsvp_role_by_user_id_trip_id:'.$this->id.':'.$trip_id, array('rsvp' => $rsvp, 'role' => $role));
...
/*
            ...
            $this->mc->replace('user_by_username:'.$username, $user);
            $this->get_fid();
...
*/
            ...
            $this->mc->delete('user_by_username:'.$this->username);
            $this->mc->delete('user_by_username:'.$username);
            $this->get_fid();
